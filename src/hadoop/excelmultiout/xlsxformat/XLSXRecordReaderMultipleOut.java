...
public class XLSXRecordReaderMultipleOut extends
		RecordReader<LongWritable, Text> {
	private static Logger LOG = Logger
			.getLogger(XLSXRecordReaderMultipleOut.class);
	...
	public void initialize(InputSplit genericSplit, TaskAttemptContext context)
		...
		try {
			Matcher MF = Pattern.compile("(?!(.*\\/))(.*?)(?=(.xlsx).*)")
		...
		is = fileIn;
		String line = new XLSXParser().parseXLSXdata(is, filename);
